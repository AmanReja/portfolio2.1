    ...
    <>
      ...
      >
        ...
        <div className="sm:pt-0 pt-[140px]  flex flex-col text-center sm:items-start items-center sm:text-left sm:w-[450px] w-full h-[550px] px-[30px] gap-[55px] sm:ml-[20px] m-0 mt-[20px]">
          ...
          <div className="sm:w-[400px] sm:px-0 px-[5px] w-full sm:justify-items-normal justify-between flex gap-[10px]">
            <Fade
              delay={200}
              duration={1000}
              fraction={0.5}
        ...
        <div className="flex sm:bottom-[-55px] bottom-[50px] flex-col opacity-[0.8] sm:w-[700px] bg-cover w-full h-[550px] px-[30px] gap-[35px] ml-[20px] mt-[20px] relative sm:left-[30%]">
          <img
            src={Fb}
            alt="world"
            // style={{
