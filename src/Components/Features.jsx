        ...
        <div className="w-full h-auto  flex justify-center items-center">
          <div className="w-full h-auto flex justify-center items-center sm:px-0 px-[2px] relative sm:bottom-0 bottom-[100px] sm:mb-[80px]">
            ...
            <div
              ...
              className="shadow-2xl bg-orange-500 h-[400px] rounded-[20px] sm:w-[400px] w-[300px] flex flex-col items-center z-10 px-[10px] pt-[100px]"
            >
              <div className="w-full flex pb-[50px] h-[80px] justify-around mt-[50px]">
        ...
        <div className=" h-full   sm:w-[30%] w-full flex-col items-center sm:place-items-start text-center sm:text-left flex gap-[30px] p-10 pr-[30px]">
          ...
          <div className="sm:w-[400px] w-full justify-center sm:items-start items-center  flex  flex-col gap-[15px]">
            ...
            <div className="flex  items-center gap-3">
              ...
              <p className="text-[18px] font-thin">Amezing page rendering</p>
            </div>
            <div className="flex  items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
